...
export const landingData: Record<string, {
    ...
    birthday: {
        groomName: "Isabella",
        brideName: "16 años",
        eventLocation: "Club Hermoso Atardecer, Cali",
        eventDate: "14 de Noviembre, 2025",
        eventTime: "6:00 PM",
        dressCode: "Elegante / Semiformral",
        ceremonyPlace: "Jardín Principal - Club Hermoso Atardecer",
        receptionPlace: "Salón de Fiestas - Club Hermoso Atardecer",
        message: "¡Estoy cumpliendo 16 y quiero celebrarlo contigo! Será una noche llena de diversión, música, risas y momentos inolvidables juntas. ¡Espero contar con tu presencia!",
        whspUrl: "https://wa.me/573201234567",
        emailUrl: "mailto:isabella.16@example.com",
    ...
    wedding: {
        groomName: "Carlos Eduardo Martínez",
        brideName: "Ana María Rodríguez",
        eventLocation: "Hacienda Los Rosales, Bogotá",
        eventDate: "15 de Diciembre, 2025",
        eventTime: "4:00 PM",
        dressCode: "Formal / Etiqueta",
        ceremonyPlace: "Jardín Principal - Hacienda Los Rosales",
        receptionPlace: "Salón de Eventos - Hacienda Los Rosales",
        message: "Queremos compartir con ustedes el día más importante de nuestras vidas. Su presencia hará de este momento algo inolvidable.",
        whspUrl: "https://wa.me/573001234567",
        emailUrl: "mailto:boda.carlosyana@example.com",
